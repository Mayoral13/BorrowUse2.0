...
import "./OGGToken.sol";
import "./SafeMath.sol";
contract BorrowandUse{
    // instance of OGG Token
    OGG myogg;
    ...
    uint TokentoEth = myogg.balanceOf(msg.sender).div(rate);
     ...
     myogg.transferFrom(msg.sender,address(this),_value.mul(rate));
    ...
    require(myogg.balanceOf(address(this)) > _value,"Insufficient Tokens in Contract");
    TokensBorrowed[msg.sender] = TokensBorrowed[msg.sender].add(_value);
    myogg.transferFrom(address(this),msg.sender, _value);
    ...
    function ReturnBorrowedETH()public payable returns(bool success){
        ...
        myogg.transferFrom(address(this),msg.sender,ETHBorrowed[msg.sender].mul(rate));
    ...
    //function to return Tokens borrowed
       ...
       require(myogg.balanceOf(msg.sender) >= TokensBorrowed[msg.sender],"Insufficient Token Balance");
        require(BorrowedTokens[msg.sender] == true,"Borrow Tokens before you can Return it");
        myogg.transferFrom(msg.sender,address(this),TokensBorrowed[msg.sender]);
    ...
    function TransferTokens(address _to,uint _value)public OnlyOwner returns(bool success){
       myogg.transferFrom(address(this),_to, _value);
